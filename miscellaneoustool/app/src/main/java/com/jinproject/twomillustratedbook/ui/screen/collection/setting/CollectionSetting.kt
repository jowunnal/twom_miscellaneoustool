package com.jinproject.twomillustratedbook.ui.screen.collection.setting
...
import com.jinproject.twomillustratedbook.databinding.CollectionSettingBinding
    ...
    override fun initState() {
        with(binding) {
            ...
            tvSettingFilter.setOnClickListener {
                val action = CollectionSettingDirections.actionCollectionSettingToCollectionSettingFilter(navArgs.category)
