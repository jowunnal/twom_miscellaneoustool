package com.jinproject.features.droplist.map
...
import com.jinproject.features.droplist.databinding.DroplistmapItemBinding
...
class DropListMapAdapter @Inject constructor(@ActivityContext val context: Context) :
    RecyclerView.Adapter<DropListMapAdapter.ViewHolder>(),
    OnClickedListener {
