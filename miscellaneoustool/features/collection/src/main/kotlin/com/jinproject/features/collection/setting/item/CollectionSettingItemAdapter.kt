...
import com.jinproject.features.collection.databinding.CollectionSettingItemListItemBinding
...
class CollectionSettingItemAdapter @Inject constructor(@ActivityContext private val context: Context):
    ListAdapter<CollectionItemState, CollectionSettingItemAdapter.ViewHolder>(diffUtil),
    OnClickedListener, Filterable {
