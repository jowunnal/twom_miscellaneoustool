...
internal fun GalleryScreen(
    ...
    GalleryScreen(
        ...
        navigateToImageDetail = { imgUri -> navigator.navigate(SymbolRoute.Detail(imgUri)) },
        popBackStack = { navigator.goBack() },
        showSnackBar = showSnackBar,
        navigateToGuildMarkPreview = { imgUri -> navigator.navigate(SymbolRoute.GuildMarkPreview(imgUri)) },
        navigateToGuildMark = { imgUri -> navigator.navigate(SymbolRoute.GuildMark(imgUri)) },
        navigateToPurchasedImage = { navigator.navigate(SymbolRoute.PurchasedImage) },
